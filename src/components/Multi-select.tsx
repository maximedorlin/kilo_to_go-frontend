...
interface MultiSelectProps
  ...
  defaultValue?: readonly string[]; // <-- updated here
  placeholder?: string;
  animation?: number;
  maxCount?: number;
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto overflow-x-hidden",
              className
            )}
                    ...
                    return (
                      <Badge
                        ...
                        className={cn(
                          ...
                          "truncate" // Ajout de la classe truncate pour couper le texte
                        )}
