...
import { useGetSingleEquipementQuery } from "@/store/apis/sanitary/equipement.api";
...
const EquipmentDetails = () => {
  ...
  const { data: equipment } = useGetSingleEquipementQuery(id as string, {
            ...
            <>
              ...
              >
                <div className="flex flex-col justify-between items-start gap-1 pt-6">
                  ...
                  <Badge className="h-full">{equipment.code}</Badge>
                </div>
                  ...
                  <Card>
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <DetailItem
                        ...
                        value={t(equipment?.equipment_name)}
                        icon={OrigamiIcon}
                      />
                      <DetailItem
                        label={t("sig_type")}
                        value={t(equipment?.equipment_type)}
                        icon={Compass}
                      />
                      <DetailItem
                        label={t("quantity")}
                        value={equipment.equipment_quantity} // faire une requête à l'api pour récupérer le point de collecte et afficher son code à la place ici
                        icon={CircleDot}
                      />
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <DetailItem
                        ...
                        value={formatDate(equipment.created_at, i18n.language)}
                      />
                      <DetailItem
                        label={t("update_date")}
                        value={formatDate(equipment.updated_at, i18n.language)}
                      />
                    </CardContent>
                  </Card>
                </motion.div>
